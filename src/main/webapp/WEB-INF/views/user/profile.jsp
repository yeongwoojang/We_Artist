...
<div class="container">
    ...
    <span class="lead">반갑습니다 </span>
    <span class="lead">프로필 정보를 설정해주세요.</span>
    <hr class="my-4">
    <p class="text-muted">
        <form class="needs-validation"  method="post" novalidate>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" aria-describedby="nameHelp" minlength="2" maxlength="50">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" id="inputPassword3" placeholder="Password" aria-describedby="passwordHelp" minlength="6" maxlength="8" required>
